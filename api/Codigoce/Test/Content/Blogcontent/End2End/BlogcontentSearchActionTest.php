...
class BlogcontentSearchActionTest extends CodigoceContentKernelTest
{
    ...
    public function testItResultPaginateWithPageAndLimit(): void
    {
        ...
        $blogcontent1 = $this->BlogcontentPersisted($this->getManager(), $this->BlogcontentFromValues(null, null, null, null, new BlogcontentHtml($searchName.Codigoce::randomString())));
        $blogcontent2 = $this->BlogcontentPersisted($this->getManager(), $this->BlogcontentFromValues(null, null, null, null, new BlogcontentHtml($searchName.Codigoce::randomString())));
