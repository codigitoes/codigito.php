...
use Codigoce\Context\Content\Blogpost\Infraestructure\Repository\BlogpostReaderDoctrine;
use Codigoce\Context\Content\Blogpost\Infraestructure\Repository\BlogpostWriterDoctrine;
...
trait TestContentBlogpostFactory
{
    ...
    final protected function RandomBlogpost(): Blogpost
    {
        return $this->BlogpostFromValues(
            BlogpostId::random(),
            new BlogpostName(Codigoce::randomString()),
            $this->BlogpostImage(),
            $this->BlogpostTags(),
            new \DateTime()
        );
