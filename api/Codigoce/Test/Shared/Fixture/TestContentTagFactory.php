...
use Codigoce\Context\Content\Tag\Infraestructure\Repository\TagReaderDoctrine;
...
trait TestContentTagFactory
{
    ...
    final protected function TagFromValues(
        ...
        is_null($name)    && $name    = new TagName(Codigoce::randomString());
    ...
    final protected function RandomTag(): Tag
    {
        return $this->TagFromValues(
            TagId::random(),
            new TagName(Codigoce::randomString()),
            $this->TagImage(),
            new \DateTime()
        );
    }
