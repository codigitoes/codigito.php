...
use Codigoce\Context\Content\Blogcontent\Infraestructure\Repository\BlogcontentReaderDoctrine;
use Codigoce\Context\Content\Blogcontent\Infraestructure\Repository\BlogcontentWriterDoctrine;
...
trait TestContentBlogcontentFactory
{
    ...
    final protected function RandomBlogcontent(): Blogcontent
    {
        return $this->BlogcontentFromValues(
            ...
            new BlogcontentHtml(Codigoce::randomString()),
