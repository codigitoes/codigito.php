...
use Codigoce\Context\Fidelization\Mailing\Domain\Exception\MailingCantSaveException;
use Codigoce\Context\Fidelization\Mailing\Domain\Exception\MailingNotFoundException;
use Codigoce\Context\Fidelization\Mailing\Domain\Exception\MailingCantDeleteException;
use Codigoce\Context\Fidelization\Mailing\Domain\Exception\MailingCantUpdateException;
use Codigoce\Context\Fidelization\Mailing\Infraestructure\Doctrine\Model\MailingDoctrine;
use Codigoce\Context\Fidelization\Mailing\Domain\Exception\InvalidMailingDuplicateEmailException;
