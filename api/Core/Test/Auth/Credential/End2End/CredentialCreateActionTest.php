...
use Core\Context\Auth\Credential\Domain\Exception\InvalidCredentialEmailException;
use Core\Context\Auth\Credential\Domain\Exception\InvalidCredentialRolesException;
...
use Core\Context\Shared\Domain\Exception\InvalidPlainPasswordException;
