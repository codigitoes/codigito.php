...
use Core\Context\Content\Fortune\Domain\Criteria\FortuneGetByIdCriteria;
use Core\Context\Content\Fortune\Infraestructure\Repository\FortuneReaderDoctrine;
use Core\Context\Content\Fortune\Infraestructure\Repository\FortuneWriterDoctrine;
