...
namespace Core\Context\Content\Blogpost\Infraestructure\Doctrine\Model;
...
/**
 * @ORM\Entity(repositoryClass="Core\Context\Content\Blogpost\Infraestructure\Repository\BlogpostWriterDoctrine", readOnly=true)
 *
