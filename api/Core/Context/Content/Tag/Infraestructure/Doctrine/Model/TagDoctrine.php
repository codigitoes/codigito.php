...
namespace Core\Context\Content\Tag\Infraestructure\Doctrine\Model;
...
/**
 * @ORM\Entity(repositoryClass="Core\Context\Content\Tag\Infraestructure\Repository\TagWriterDoctrine", readOnly=true)
 *
 * @ORM\Table(name="tags")
 */
