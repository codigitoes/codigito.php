...
namespace Core\Context\Content\Fortune\Infraestructure\Repository;

use Core\Context\Content\Fortune\Domain\Exception\FortuneCantDeleteException;
use Core\Context\Content\Fortune\Domain\Exception\FortuneCantSaveException;
use Core\Context\Content\Fortune\Domain\Exception\FortuneNotFoundException;
use Core\Context\Content\Fortune\Domain\Exception\InvalidFortuneDuplicateEmailException;
...
use Core\Context\Content\Fortune\Infraestructure\Doctrine\Model\FortuneDoctrine;
