...
namespace Core\Context\Content\Fortune\Infraestructure\Doctrine\Model;
...
/**
 * @ORM\Entity(repositoryClass="Core\Context\Content\Fortune\Infraestructure\Repository\FortuneWriterDoctrine", readOnly=true)
 *
