...
use Core\Context\Auth\Credential\Domain\Exception\CredentialCantDeleteException;
use Core\Context\Auth\Credential\Domain\Exception\CredentialCantSaveException;
use Core\Context\Auth\Credential\Domain\Exception\CredentialCantUpdateException;
use Core\Context\Auth\Credential\Domain\Exception\CredentialNotFoundException;
use Core\Context\Auth\Credential\Domain\Exception\InvalidCredentialDuplicateEmailException;
