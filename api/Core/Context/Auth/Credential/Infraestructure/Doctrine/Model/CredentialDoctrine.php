...
namespace Core\Context\Auth\Credential\Infraestructure\Doctrine\Model;
...
/**
 * @ORM\Entity(repositoryClass="Core\Context\Auth\Credential\Infraestructure\Repository\CredentialWriterDoctrine", readOnly=true)
 *
