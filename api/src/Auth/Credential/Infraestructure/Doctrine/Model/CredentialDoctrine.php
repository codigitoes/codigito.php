...
namespace Codigito\Auth\Credential\Infraestructure\Doctrine\Model;
...
/**
 * @ORM\Entity(repositoryClass="Codigito\Auth\Credential\Infraestructure\Repository\CredentialWriterDoctrine", readOnly=true)
 *
